...
ALTERA_IMAGE_INSTALL ?= "util-linux initramfs-altera kernel-modules netbase init-ifupdown busybox base-passwd base-files tinylogin sysvinit initscripts e2fsprogs mtd-utils gdb gdbserver bash strace openssh openssl elfutils sysfsutils usbutils dtc gawk ethtool grep lighttpd iputils make pciutils portmap sed setserial wget autoconf diffutils perl minicom valgrind i2c-tools lttng-tools iptables oprofile gator openssh-sftp-server memtool nfs-utils-client gcc eglibc-dev libgcc-dev "
