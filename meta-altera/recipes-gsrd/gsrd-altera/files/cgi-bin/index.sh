...
echo -e "<head>"
	echo -e "<title>Board Update Portal: Cyclone V SX SoC Development Kit</title>"
...
echo -e "Cyclone V SX SoC Development Kit "
echo -e "</div>"
echo -e "</div>"
...
echo -e "<span><strong><h1>Cyclone V SX SoC Development Kit Features</h1></strong><br/>"
echo -e "Mouse over the board photo to view features.</span>"

echo -e "<span class=\"dev-kit-flash\">"
echo -e "<script type=\"text/javascript\">"
echo -e "AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','640','height','478','src','board-flash','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../board-flash');"
echo -e "</script>"
echo -e "<noscript>"
...
echo -e "<param name=\"movie\" value=\"board-flash.swf\" />"
echo -e "<param name=\"quality\" value=\"high\" />"
echo -e "<embed src=\"../board-flash.swf\" quality=\"high\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"640\" height=\"478\"></embed>"
echo -e "</object>"
echo -e "</noscript>"
echo -e "</span>"
...
echo "<hr style=\"border: 1px solid; color:#06c\"><br>"
echo -e "<span><strong><h1>Interacting with Cyclone V SX SoC Development Kit</h1></strong><br/>"
echo -e "</span>"
